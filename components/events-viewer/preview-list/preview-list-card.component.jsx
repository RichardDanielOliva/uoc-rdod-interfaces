...
import { EventListContainer, EventCardContainer, EventViewContent, EventViewLocation, EventViewPrice, EventViewSubTitle, EventViewTitle, EventViewImageContainer } from '../event-viewer-card.styles';

const EventCard = ({ event }) => {
  return (
    <EventCardContainer className='list'>
